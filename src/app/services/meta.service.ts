  ...
  addTags(pageTitle: string, product?: Product) {
    if (product === undefined) {
      ...
      this.meta.addTags([
        ...
        { property: 'twitter:card', content: 'summary_large_image' },
        { property: 'twitter:image', content: `${product.asset_url}` },
        ...
        { property: 'product:retailer_item_id', content: `${product.product_id}` },
        { property: 'product:catalog_id', content: `${product.product_id}` },
